...
const inputStyle =
	"text-sm lg:text-base p-2 lg:px-4 lg:py-2 col-span-2 rounded-md";
		...
		<div className="w-full h-screen flex items-center justify-center">
			<div className="container mt-10 lg:mt-20 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-20">
				<div className="space-y-3 lg:space-y-8">
					<h2 className="text-3xl lg:text-5xl font-extrabold leading-9 tracking-wide text-transparent bg-clip-text bg-gradient-to-br hover:bg-gradient-to-tr from-textColor to-accentColor duration-300">
				...
				<form className="grid grid-cols-2 gap-2 lg:gap-4 text-bgColor">
					<input
						placeholder="Name"
						className="col-span-1 text-sm lg:text-base p-2 lg:px-4 lg:py-2 rounded-md"
					/>
					<input
						placeholder="Phone"
						className="col-span-1 text-sm lg:text-base p-2 lg:px-4 lg:py-2 rounded-md"
